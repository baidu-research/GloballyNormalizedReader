...
from constants import EMBEDDING_DIM, EOS, PAD, SOS, UNK
...
class Vocab(object):
    ...
    def __init__(self, path):
        ...
        with open(os.path.join(path, "vocab.txt"), "rt") as f:
...
def load_word_vectors(param, vocab, path, verbose=True,
        ...
        try:
            ...
            try:
                ...
                if not found:
                    ...
                    missing += 1
    if verbose:
        print("Loaded {} words, {} missing".format(len(vocab) - missing, missing), flush=True)
